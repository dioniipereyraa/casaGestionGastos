...
('Alimentacion', 'Comida, supermercado, restaurantes', 'gasto', '#28a745'),
('Servicios', 'Luz, gas, agua, internet, telefono', 'gasto', '#dc3545'),
('Transporte', 'Combustible, mantenimiento vehiculo, transporte publico', 'gasto', '#ffc107'),
('Hogar', 'Alquiler, expensas, mantenimiento, decoracion', 'gasto', '#17a2b8'),
('Salud', 'Medicamentos, consultas medicas, obras sociales', 'gasto', '#e83e8c'),
('Entretenimiento', 'Salidas, streaming, deportes, hobbies', 'gasto', '#6f42c1'),
('Educacion', 'Cursos, libros, materiales de estudio', 'gasto', '#fd7e14'),
